public class Main {
    ...
    public static void task3() {
        System.out.println("\n"+"Задача 3");
        for (int i =0; i <=17; i =i +2 ) System.out.print(i +", ");
    }
    ...
    public static void task5() {
        System.out.println("\n"+"Задача 5");
        for (int i =1904; i <=2096; i =i +4) System.out.println(i+" год является високосным");
    }
    public static void task6() {
        System.out.println("Задача 6");
        for (int i =7; i <=98; i =i +7 ) System.out.print(i +" ");
    }
